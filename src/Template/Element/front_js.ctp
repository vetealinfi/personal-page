    ...
    <script src="<?= $this->Url->build('/template_front/') ?>js/jquery.magnific-popup.min.js"></script>
    <script src="<?= $this->Url->build('/template_front/') ?>js/jquery-aspieprogress.min.js"></script>
    <script src="<?= $this->Url->build('/template_front/') ?>js/plugins.js"></script>
    <script src="<?= $this->Url->build('/template_front/') ?>js/scripts.js"></script>
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/589d3050a8edb309fa9aadf3/default';
        s1.charset='UTF-8';
