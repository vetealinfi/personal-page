...
<html class="no-js" lang="es">
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="<?= $this->Url->build('/template_front/') ?>ico/favicon.ico">
        ...
        <script src="<?= $this->Url->build('/template_front/') ?>js/modernizr-2.8.3.min.js"></script>
