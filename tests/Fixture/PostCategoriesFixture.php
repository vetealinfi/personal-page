...
class PostCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 2000, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'photo' => ['type' => 'string', 'length' => 1000, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'lft' => 1,
                'rght' => 1,
                'created' => '2019-04-09 15:56:21',
                'modified' => '2019-04-09 15:56:21'
            ],
        ];
        parent::init();
    }
